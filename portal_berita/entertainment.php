...
$sql_get_berita = "SELECT * FROM berita WHERE id_kategori='1' ORDER BY id_berita DESC, tanggal DESC";
...
$responseberita = ['status' => $status, 'berita' => $response_data];
// tampilkan dan convert ke format json
echo json_encode($responseberita);